...
export class Natively {
  ...
  observers: Function[] = [];
  isIOSApp: boolean = window?.navigator?.userAgent?.includes("Natively/iOS") || false;
  isAndroidApp: boolean = window?.navigator?.userAgent?.includes("Natively/Android") || false;
